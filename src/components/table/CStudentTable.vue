        ...
        <table class="min-w-full leading-normal border-spacing-y-4 border-separate">
          ...
          <tbody>
            <tr
              ...
              :key="user.id"
              class="gap-y-2 bg-white rounded-lg my-2 gap-3"
            >
              <td class="px-5 py-5">
                <div class="flex">
              ...
              <td class="px-5 py-5">
                <p class="text-black whitespace-no-wrap">
                  {{ user.type == 1 ? 'Bakalavr' : 'Magistr' }}
                </p>
              </td>
              <td class="px-5 py-5 text-center">
                <p class="text-black whitespace-no-wrap">{{ user?.institute.name }}</p>
              </td>
              <td class="px-5 py-5">
                <p class="text-black text-base font-semibold whitespace-no-wrap">
                  {{ user.given }} <span class="text-[#B2B7C1]">UZS</span>
                </p>
              </td>
              <td class="px-5 py-5">
                <p class="text-black text-base font-semibold whitespace-no-wrap">
                  {{ formatNumber(user.contract) }} <span class="text-[#B2B7C1]">UZS</span>
                </p>
              </td>
