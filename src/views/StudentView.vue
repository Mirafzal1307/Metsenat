      ...
      <div class="grid grid-cols-8">
        ...
        >
          ...
          <div class="w-full my-2">
            <span class="bg-blue-100 p-1 text-blue-600 rounded-md text-xs font-extrabold">
              Asosiy malumotlar
            </span>
          </div>
          <div class="flex gap-4 justify-start w-full pt-4 items-center">
            ...
            <h3 class="text-2xl font-bold capitalize">{{ studentInfo.full_name }}</h3>
          </div>
          <div class="w-full pt-6">
            <p class="uppercase text-gray-400 font-semibold text-sm pb-3">telefon raqami</p>
            <p class="text-base font-bold">{{ formatPhoneNumber(studentInfo.phone) }}</p>
          </div>
          <div class="w-full my-4">
            <span class="bg-blue-100 p-1 text-blue-600 rounded-md text-xs font-extrabold">
              O'qishi haqida malumotlar
            </span>
          </div>
          <div class="flex w-full pt-2">
            ...
            <div class="w-full">
              ...
              <p class="text-base font-bold">
                {{ studentInfo.type === 2 ? 'Magistr' : 'Bakalavr' }}
              </p>
            </div>
          </div>
          <div class="flex w-full pt-5">
            <div class="w-full">
              <p class="uppercase text-gray-400 font-semibold text-sm pb-3">Ajratilingan summa</p>
              <p class="text-base font-bold">{{ formatNumber(studentInfo.given) }}UZS</p>
            </div>
            <div class="w-full">
              <p class="uppercase text-gray-400 font-semibold text-sm pb-3">Kontrakt miqdori</p>
              <p class="text-base font-bold">{{ formatNumber(studentInfo.contract) }} UZS</p>
            </div>
          </div>
        </div>
      </div>
...
import { formatPhoneNumber, formatNumber } from '@/utils/utils.js'
